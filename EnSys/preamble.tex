...
% --------------------------------------- COLOR DEFINITIONS ---------------------------------------
\definecolor{sectioncolor}{HTML}{1F4D3A}      % dunkles Tannengrün
\definecolor{subsectioncolor}{HTML}{DDEBE4}   % sehr helles Grün-Beige
\definecolor{sectextcol}{HTML}{FFFFFF}        % weisser Text für starken Kontrast
