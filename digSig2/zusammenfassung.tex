...
% ========================================= DOCUMENT INFO =========================================
\def\title{Digital Signal Processing 2}       % title
\def\shorttitle{Digital Signal Processing 2}                            % short title (displayed as PDF title)
\def\dozent{Dr. Heinz Mathis }               % docent
...
\begin{document}
    \begin{layout}
        \input{sections/01_digitalFilterRealizations.tex}
        \input{sections/02_digitalWaveformGenerators.tex}
    \end{layout}
\end{document}
