...
\usepackage{empheq}                 % boxes around multiple equations
...
% custom command for transpose
\newcommand{\tps}{\ensuremath{^{\text{\slshape\tiny T}}}} % ChkTeX5
