\section{Übunsstützen}
% =========================================================
\subsection{Übung 1: Zeitbereichanalyse R--L Lasten}
% =========================================================

\subsubsection*{a) Zeitfunktion des Stromes $i_R(t)$ im stationären Betrieb}
...
\subsubsection*{b) Mittelwert $\overline{i_R}$}
...
\subsubsection*{c) Effektivwert $I_{\mathrm{RMS}}$}
...
\subsubsection*{d) Spannungen $u_R(t)$ und $u_L(t)$}
...
\subsubsection*{e) Simulation/Verifikation (LTspice/PLECS)}
...
% =========================================================
\subsection{Übung 2: Einpuls-Gleichrichter M1U }
% =========================================================

\subsubsection*{a) Zeitverlauf $u_2(t)$ und $u_R(t)$ für $t\in[0,60\,\mathrm{ms}]$}
...
\subsubsection*{b) Mittelwert und Effektivwert von $u_R(t)$}
...
\subsubsection*{c) Erste sechs Harmonische von $u_R(t)$}
...
% =========================================================
\subsection{Übung 3: Zweipuls-Gleichrichter}
% =========================================================

\subsubsection*{a) Zeitverlauf $u_2(t)$ und $u_R(t)$ über drei Perioden}
...
\subsubsection*{c) Harmonische (Fourier-Koeffizienten)}
...
% =========================================================
\subsection{Übung 4: Wechselstromsteller W1 (R-Last)}
% =========================================================

\subsubsection*{a) Zeitverlauf von $u_R(t)$ und $i_R(t)$ für $t\in[0,60\,\mathrm{ms}]$}
...
\subsubsection*{b) Mittelwert und Effektivwert von $u_R(t)$ und $i_R(t)$}
...
\subsubsection*{c) Wirkleistung $P$ an der ohmschen Last}
...
\subsubsection*{d) Fourierkoeffizienten von $i_R(t)$ (Spektrum)}
...
\subsubsection*{e) Blindleistung und Verzerrungsblindleistung}
...
% =========================================================
\subsection{Übung 5: Gleichstromsteller (Schalter) }
% =========================================================

\subsubsection*{a) $i_L(t)$ und $u_R(t)$ über eine Schaltperiode}
...
\subsubsection*{b) Bestimmung einer Schaltzeit aus $i_{\min}$, $i_{\max}$ (typische Prüfungsform)}
...
% =========================================================
\subsection{Übung 6: PWM-Wechselrichter }
% =========================================================

\subsubsection*{a) Herleitung von $i_L(t)$ und $u_L(t)$ in einem PWM-Intervall}
...
\subsubsection*{b) Wodurch wird die Hauptfrequenz des Laststroms bestimmt?}
...
\subsubsection*{c) Vergleich idealer und realer Laststrom (qualitativ)}
...
% =========================================================
\subsection{Übung 7: Gesteuerter Gleichrichter + Gleichstrommaschine}
% =========================================================

\subsubsection*{a) Warum läuft die Maschine unterhalb einer Winkelgrenze nicht sauber an?}
...
\subsubsection*{b) Warum steigt $n$ mit $\alpha$ zuerst, erreicht ein Maximum und fällt dann wieder?}
...
\subsubsection*{c) Grenzbedingung für den Stromfluss}
