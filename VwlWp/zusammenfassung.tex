...
\begin{document}
    \begin{layout}
        \input{sections/01_Wohlstand.tex}
        \input{sections/02_Wirtschaftswachstum.tex}
        \input{sections/03_Wohlstandsverteilung.tex}
        \input{sections/04_1Konjunktur.tex}
        \input{sections/05_Makrooekonomisches_Modell.tex}
    \end{layout}
\end{document}
