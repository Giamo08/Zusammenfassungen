...
% --------------------------------------- COLOR DEFINITIONS ---------------------------------------
\definecolor{sectioncolor}{HTML}{BFA88A}      
\definecolor{subsectioncolor}{HTML}{F4EFE7}   
...
\titleformat{\subsection}
            ...
            {%
                ...
                \begingroup
                \setlength{\fboxsep}{2pt}%
                \colorbox{subsectioncolor}{%
                    \parbox{\dimexpr\columnwidth-2\fboxsep\relax}{%
                        \color{subsectextcol}\thesubsection\ #1%
                    }%
                }%
                \endgroup
            }
